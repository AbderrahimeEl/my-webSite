...
import { certificationsInfo } from "../Details";
import { Personwithlap } from "../Details";
import { certificationsInfo } from "../Details";
import { Personwithlap } from "../Details";
        ...
        <div className="col-md-6">
          <div>
            <p className="fs-5 text-muted">
              ...
              Distributed IT Systems Engineering at <span className="text-primary">
              ENSET Mohammedia .{" "}
              </span>{" "} Currently
              20 years old, I'm seeking internship opportunities to gain
              practical experience in the field. <br />I'm enthusiastic about
              collaborating on projects and eager to explore new opportunities
