...
function Project({
  ...
  return (
    <article className="card rounded-xl mt-10 shadow-xl">
      <img className="card-img-top" src={image} alt="" loading="lazy" />
      <div className="card-body">
        <h3 className="card-title font-semibold text-lg pt-1">{title}</h3>
        <p className="card-text pt-4 font-light">{description}</p>
        <h4 className="card-subtitle text-muted font-medium pt-4">
        ...
        <div className="d-flex justify-content-between align-items-center mt-5">
          <div className="d-flex align-items-center">
            ...
            <a
              ...
              className="card-link pl-2 font-light dark:text-white"
            >
              Live Preview
            </a>
          </div>
